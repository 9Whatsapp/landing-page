  ...
  <nav class="fixed top-0 left-0 right-0 z-50 border-b border-white/[0.04] bg-gray-950/80 backdrop-blur-md">
    <div class="mx-auto max-w-5xl px-5 sm:px-8">
      <div class="flex items-center justify-between py-3.5">
        <a href="/" class="flex items-center gap-2 rounded-md focus-visible:ring-2 focus-visible:ring-white/20 focus-visible:outline-none">
          <span class="flex h-7 w-7 items-center justify-center rounded-md bg-whatsapp/10 text-whatsapp">
