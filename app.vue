  ...
  <div class="relative min-h-screen bg-gray-950">
    ...
    >
      <button
        v-if="isVisible"
        @click="scrollToTop"
        class="fixed bottom-6 right-6 z-50 flex h-10 w-10 items-center justify-center rounded-full border border-white/[0.08] bg-[#090e0c]/90 text-gray-400 hover:text-white hover:border-whatsapp/30 hover:bg-[#0c1411]/95 transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.3)] focus:outline-none focus:ring-2 focus:ring-whatsapp/50"
